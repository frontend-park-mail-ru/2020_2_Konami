...
;pug_debug_line = 6;pug_debug_filename = "MeetTemplate.pug";
pug_html = pug_html + "\u003Cdiv class=\"meetheadright\"\u003E";
;pug_debug_line = 7;pug_debug_filename = "MeetTemplate.pug";
if (reg) {
;pug_debug_line = 8;pug_debug_filename = "MeetTemplate.pug";
pug_html = pug_html + "\u003Cbutton class=\"gobutton\"\u003E";
;pug_debug_line = 8;pug_debug_filename = "MeetTemplate.pug";
pug_html = pug_html + "Отменить поход\u003C\u002Fbutton\u003E";
}
else {
;pug_debug_line = 10;pug_debug_filename = "MeetTemplate.pug";
pug_html = pug_html + "\u003Cbutton class=\"gobutton\"\u003E";
;pug_debug_line = 10;pug_debug_filename = "MeetTemplate.pug";
pug_html = pug_html + "Пойти\u003C\u002Fbutton\u003E";
}
;pug_debug_line = 11;pug_debug_filename = "MeetTemplate.pug";
pug_html = pug_html + "\u003Cdiv class=\"likeicon\"\u003E";
;pug_debug_line = 12;pug_debug_filename = "MeetTemplate.pug";
if (like) {
;pug_debug_line = 13;pug_debug_filename = "MeetTemplate.pug";
pug_html = pug_html + "\u003Cimg src=\"..\u002F..\u002Fassets\u002Flike.svg\"\u002F\u003E";
}
else {
;pug_debug_line = 15;pug_debug_filename = "MeetTemplate.pug";
pug_html = pug_html + "\u003Cimg src=\"..\u002F..\u002Fassets\u002Fheart.svg\"\u002F\u003E";
}
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
;pug_debug_line = 16;pug_debug_filename = "MeetTemplate.pug";
pug_html = pug_html + "\u003Cimg" + (" class=\"meetbigimg\""+pug_attr("src", imgSrc, true, false)) + "\u002F\u003E";
;pug_debug_line = 17;pug_debug_filename = "MeetTemplate.pug";
pug_html = pug_html + "\u003Cdiv class=\"meetbottom\"\u003E";
;pug_debug_line = 18;pug_debug_filename = "MeetTemplate.pug";
pug_html = pug_html + "\u003Cdiv class=\"meetbottomleft\"\u003E";
;pug_debug_line = 19;pug_debug_filename = "MeetTemplate.pug";
pug_html = pug_html + "\u003Ch1 class=\"aboutitile\"\u003E";
;pug_debug_line = 19;pug_debug_filename = "MeetTemplate.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = title) ? "" : pug_interp)) + "\u003C\u002Fh1\u003E";
;pug_debug_line = 20;pug_debug_filename = "MeetTemplate.pug";
pug_html = pug_html + "\u003Cspan\u003E";
;pug_debug_line = 20;pug_debug_filename = "MeetTemplate.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = text) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E";
;pug_debug_line = 21;pug_debug_filename = "MeetTemplate.pug";
pug_html = pug_html + "\u003Cdiv class=\"verticalseparator\"\u003E";
;pug_debug_line = 22;pug_debug_filename = "MeetTemplate.pug";
// iterate tags
;(function(){
  var $$obj = tags;
  if ('number' == typeof $$obj.length) {
      for (var index = 0, $$l = $$obj.length; index < $$l; index++) {
        var val = $$obj[index];
;pug_debug_line = 23;pug_debug_filename = "MeetTemplate.pug";
